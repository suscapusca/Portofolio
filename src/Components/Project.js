...
function Project({ title, image, description, techstack, previewLink, githubLink }) {
  return (
    <article className="rounded-xl mt-10 overflow-hidden shadow-xl shadow-slate-300 dark:shadow-slate-900" style={{ height: "400px" }}>
      <img src={image} alt="" loading="lazy" style={{ height: "200px", width: "100%", objectFit: "cover" }} />
      <div className="dark:bg-dark-card p-4" style={{ height: "200px" }}>
